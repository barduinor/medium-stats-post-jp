    ...
    def get_all_story_stats(self, post_ids, type_="view_read"):
        ...
        for post in tqdm(post_ids):
            try:
                ...
                # print(f"Successfully fetched data for post {post}")
                sleep(1) # not sure what the rate limit is... 0.2 used to work...
            except HTTPError as e:
                print(f"Error fetching data for post {post}:{e.args}")
                continue
